...
1. Component 1 describes an employee's worklife (average hours worked, number of projects, etc.), highlighting an important link between these data points. The other components describe other functions at the company. One item to note is that there is a correlation between the management group and recently promoted employees. 

2. We have chosen to use 10 factors. 
